    ...
    return (
        <section className="container mx-auto">
            <div className='flex flex-col justify-center items-center relative py-10'>
                ...
                <div>
                    <div className="absolute top-8 md:top-5 lg:top-2 left-0 2xl:left-0 lg:left-[-20px]">
                    ...
                    <div className="absolute sm:top-8 md:top-10 lg:top-10 top-6 right-0">
                    ...
                    <div className="absolute sm:left-0 md:top-80 md:left-[-25px] lg:left-0 top-64 left-0">
                    ...
                    <div className="absolute top-[27rem] right-0">
                    ...
                    <div className="absolute sm:left-10 sm:bottom-48 md:bottom-44 md:left-10 lg:bottom-40 lg:left-56 bottom-72 left-2">
