        ...
        <>
            <div className="container mx-auto">
                ...
                <div className="flex flex-wrap xl:justify-between justify-center gap-10">
                    <div>
                        <div className="h-full bg-main p-10 rounded-3xl border-t-[3px] border-l-[1px] border-r-[1px] border-b-[0px] border-[#6AC6AD] flex flex-col relative overflow-hidden">
                            ...
                            <div className="flex-grow">
                                ...
                                <h1 className="text-[71.03px] leading-[71.03px] sm:text-[75px] sm:leading-[85px] md:text-[80px] md:leading-[95px] lg:text-[85px] lg:leading-[105px] xl:text-[88px] xl:leading-[110px] 2xl:text-[90px] 2xl:leading-[113px] pb-4 mb-4 font-semibold text-white tracking-[3%]">$0
                                    <span className="text-[11px] leading-[14px] sm:text-[12px] sm:leading-[15px] md:text-[12.5px] md:leading-[16px] lg:text-[13px] lg:leading-[17px] xl:text-[13.5px] xl:leading-[17.5px] 2xl:text-[14px] 2xl:leading-[18px] font-normal text-[#E1E1E1]">
                                        Per user per month
                                    </span>
                    ...
                    <div>
                        <div className="h-full bg-main p-10 rounded-3xl border-t-[3px] border-l-[1px] border-r-[1px] border-b-[0px] border-[#DFB06E] flex flex-col relative overflow-hidden">
                            ...
                            <div className="flex-grow">
                                ...
                                <h1 className="text-[71.03px] leading-[71.03px] sm:text-[75px] sm:leading-[85px] md:text-[80px] md:leading-[95px] lg:text-[85px] lg:leading-[105px] xl:text-[88px] xl:leading-[110px] 2xl:text-[90px] 2xl:leading-[113px] pb-4 mb-4 font-semibold text-white tracking-[3%]">$15
                                    <span className="text-[11px] leading-[14px] sm:text-[12px] sm:leading-[15px] md:text-[12.5px] md:leading-[16px] lg:text-[13px] lg:leading-[17px] xl:text-[13.5px] xl:leading-[17.5px] 2xl:text-[14px] 2xl:leading-[18px] font-normal text-[#E1E1E1]">
                                        Per user per month
                                    </span>
                    ...
                    <div className=''>
                        <div className="h-full bg-main p-6 sm:p-10 rounded-3xl border-t-[3px] border-l-[1px] border-r-[1px] border-b-[0px] border-[#33B5E2] flex flex-col relative overflow-hidden">

                            <div className="flex-grow">
                                <h2 className="tracking-widest mb-1 font-semibold text-[37px] leading-[74px] sm:text-[40px] sm:leading-[78px] md:text-[42px] md:leading-[82px] lg:text-[44px] lg:leading-[88px] xl:text-[46px] xl:leading-[92px] 2xl:text-[48px] 2xl:leading-[94px] text-white">Premium</h2>
                                <h1 className="text-[71.03px] leading-[71.03px] sm:text-[75px] sm:leading-[85px] md:text-[80px] md:leading-[95px] lg:text-[85px] lg:leading-[105px] xl:text-[88px] xl:leading-[110px] 2xl:text-[90px] 2xl:leading-[113px] pb-4 mb-4 font-semibold text-white tracking-[3%]">$150
                                    <span className="text-[11px] leading-[14px] sm:text-[12px] sm:leading-[15px] md:text-[12.5px] md:leading-[16px] lg:text-[13px] lg:leading-[17px] xl:text-[13.5px] xl:leading-[17.5px] 2xl:text-[14px] 2xl:leading-[18px] font-normal text-[#E1E1E1]">
                                        Per user per month
                                    </span>
