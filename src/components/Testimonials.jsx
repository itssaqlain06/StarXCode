    ...
    return (
        <>
            ...
            <div className="overflow-hidden mb-10">
                <div className="animate-scroll-left flex space-x-2">
                    {Array(5).fill(0).map((_, index) => (
                        <div key={index} className="testimonial-card rounded-2xl bg-main text-white p-6 shadow-sm sm:p-8">
            ...
            <div className="overflow-hidden">
                <div className="animate-scroll-right flex space-x-2">
                    {Array(5).fill(0).map((_, index) => (
                        <div key={index} className="testimonial-card rounded-2xl bg-main text-white p-6 shadow-sm sm:p-8">
                            <div className="flex items-center gap-4">
                                <img
